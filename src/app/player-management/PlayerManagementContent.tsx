...
import { roundTimeToCharge, calculatePrice } from "~/lib/pricing";
// @ts-ignore
...
function calculateCost(startTime: Date | string, hourlyRate: number, deviceType: string, playerCount: number): string {
  // For Frame devices, cost is Rs 50 * player count
  if (deviceType === "FRAME") {
    return (50 * playerCount).toFixed(2);
  }
  ...
  try {
    ...
    const cost = (Number(hourlyRate) / 60) * roundedTime;
    return cost.toFixed(2);
  }
}
                ...
                <div className="flex justify-between items-center px-6 py-4 border-b border-gray-200">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <h2 className="text-lg font-semibold text-gray-800">#{token.tokenNo}</h2>
                    </div>
                  </div>
                  <button
